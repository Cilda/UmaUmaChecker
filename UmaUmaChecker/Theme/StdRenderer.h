...
class StdRenderer final : public BaseRenderer
{
	wxDECLARE_DYNAMIC_CLASS(StdRenderer);
...
public:
	...
	virtual wxColour GetBackgroundColor() { return wxColor(255, 255, 255); }
	virtual void DrawPushButton(wxWindow* control, wxDC& dc, const wxRect& rect, int oldState, int state) override;
